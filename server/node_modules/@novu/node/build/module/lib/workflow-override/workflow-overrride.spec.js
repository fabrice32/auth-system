...
describe('test use of novus node package - Workflow overrride class', () => {
    ...
    test('should update the given workflow override', async () => {
        ...
        const result = await novu.workflowOverrides.updateOneByTenantIdandWorkflowId('WORKFLOW_ID', 'TENANT_ID', {
            active: true,
        });
    ...
    test('should fetch the workflow-overide with the given tenant id', async () => {
        ...
        mockedAxios.get.mockResolvedValue(mockedResponse);
        const result = await novu.workflowOverrides.getOneByTenantIdandWorkflowId('WORKFLOW_ID', 'TENANT_ID');
        expect(mockedAxios.get).toHaveBeenCalled();
